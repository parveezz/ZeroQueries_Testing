...
import { Shield, Eye, Settings, FileCheck, Lock, Clock, Share2 } from 'lucide-react';
...
const Governance: React.FC<Props> = ({ t, lang }) => {
  const icons = [Shield, Eye, Settings, FileCheck, Lock, Clock, Share2];
